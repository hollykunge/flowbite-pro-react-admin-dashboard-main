...
import { HiLightningBolt, HiOutlineLightBulb, HiOutlineDocumentText } from "react-icons/hi";
  ...
  return (
    <div className="flex h-full flex-col items-center justify-between bg-white dark:bg-gray-900">
      ...
      <div className="mt-12 text-center">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white">ChatGPT</h1>
      </div>
      ...
      <div className="flex w-full max-w-3xl flex-col items-center">
        ...
        <div className="mb-8 w-full">
          <h2 className="mb-3 text-lg font-medium text-gray-900 dark:text-white">示例</h2>
