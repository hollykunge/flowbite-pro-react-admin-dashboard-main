 ...
 * @property {() => void} [onDownload] - 下载按钮点击事件处理函数
 */
interface FileMessageProps {
  fileName: string;
  fileSize?: string;
...
/**
 * 文件消息组件
 * 用于在聊天消息中显示文件类型的消息，包括文件图标、名称、大小和下载按钮
 */
const FileMessage: FC<FileMessageProps> = ({
  ...
  return (
    <div className="flex w-full max-w-[320px] flex-col rounded-e-xl rounded-es-xl border-gray-200 bg-gray-100 p-4 leading-normal dark:bg-gray-700">
      <div className="flex items-start rounded-xl bg-gray-50 p-2 dark:bg-gray-600">
        <div className="me-2">
          <span className="flex items-center gap-2 pb-2 text-sm font-medium text-gray-900 dark:text-white">
            <svg
              fill="none"
              aria-hidden="true"
        ...
        <div className="inline-flex items-center self-center">
          <button
            className="inline-flex items-center self-center rounded-lg bg-gray-50 p-2 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500 dark:focus:ring-gray-600"
            type="button"
